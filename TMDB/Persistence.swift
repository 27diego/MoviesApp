...
////container that encapsulated CoreData stack
class StorageProvider {
    let persistanceContainer: NSPersistentContainer
    static var shared = StorageProvider()
    
    init(){
        persistanceContainer = NSPersistentContainer(name: "TMDB")
...
////container that encapsulates CoreData stack
